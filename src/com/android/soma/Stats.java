...
public class Stats {
    ...
    private static final String TAG = "soma/Stats";

    private static final boolean LOCAL_LAUNCH_LOG = true;

    public static final String ACTION_LAUNCH = "com.android.soma.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.android.soma.permission.RECEIVE_LAUNCH_BROADCASTS";
